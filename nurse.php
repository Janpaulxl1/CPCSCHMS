...
<ul>
<li><a href="nurse_assessment.php"><i class="fas fa-file-medical"></i> Student Physical Assessment Form</a></li>
...
<a href="convert_responder.php"><i class="fas fa-user-shield"></i> Student Responder Designation</a>
<a href="responder_status.php"><i class="fas fa-user-shield"></i> Student Responder Status</a>
