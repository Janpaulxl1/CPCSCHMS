...
<body class="bg-gray-200 relative min-h-screen">
  ...
  <header class="p-4 text-white relative">
    <div class="flex items-center space-x-4">
      <button id="menuBtn" class="text-2xl font-bold text-white cursor-pointer rounded p-2 transition">☰</button>
      <!-- top-left label if needed -->
      <div class="text-white font-bold text-lg">School Health Clinic Management System</div>
    </div>
    ...
    <div id="sidebar">
      ...
      <a href="convert_responder.php"><i class="fas fa-user-plus"></i> Convert Responder</a>
              ...
              <div class="overflow-x-auto">
                <table class="min-w-full tbl-border text-sm">
                  <thead class="bg-red-600 text-white">
                    <tr>
                      <th class="px-4 py-2 text-left"><i class="fas fa-tag"></i> Brand Name</th>
                      <th class="px-4 py-2 text-left"><i class="fas fa-pills"></i> Medicine Name</th>
                      <th class="px-4 py-2 text-left"><i class="fas fa-flask"></i> Dosage</th>
                      <th class="px-4 py-2 text-left"><i class="fas fa-info-circle"></i> Usage</th>
                      <th class="px-4 py-2 text-left"><i class="fas fa-hashtag"></i> Quantity</th>
                        ...
                        <tr class="text-black">
                          ...
                          <td class="px-4 py-2 text-center">
                            <button
                              ...
                              data-delivery-date="<?= htmlspecialchars($row['delivery_date'] ?? '') ?>"
                            ...
                            <form action="delete_medication.php" method="POST" class="inline">
                              ...
                              <button type="submit" class="inline-block px-2 py-1 rounded bg-red-500 text-white hover:bg-red-600"><i class="fas fa-trash"></i></button>
                            </form>
                          </td>
                        </tr>
                      <?php endwhile; ?>
  ...
  <div id="addModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
      ...
      <form action="add_medicine.php" method="POST" class="space-y-3">
        <input type="text" name="brand" placeholder="Brand Name" class="w-full border p-2 rounded">
  ...
  <div id="editModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-md shadow-lg">
      ...
      <form action="update_medicine.php" method="POST" class="space-y-3">
        ...
        <input type="text" name="brand" id="edit_brand" placeholder="Brand Name" class="w-full border p-2 rounded">
        ...
        <label class="block text-sm font-medium text-gray-700">Delivery Date</label>
        <input type="date" name="delivery_date" id="edit_delivery_date" class="w-full border p-2 rounded">
        <label class="block text-sm font-medium text-gray-700">Expiration Date</label>
        <input type="date" name="expiration_date" id="edit_expiration_date" class="w-full border p-2 rounded" required>
        <textarea name="notes" id="edit_notes" placeholder="Notes" class="w-full border p-2 rounded"></textarea>
        <div class="flex justify-end gap-2">
  ...
  <script>
    ...
    function openEditModal(button) {
      ...
      const delivery_date = button.getAttribute('data-delivery-date');
