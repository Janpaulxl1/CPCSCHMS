...
<head>
    ...
    <style>
    /* Professional styling with gradient background and white header */
    body {
      background: white;
      min-height: 100vh;
    ...
    #visitLogsCard tbody tr:nth-child(odd) {
      background: white;
      color: #374151;
    }
...
<header class="p-4 text-white relative">
  <div class="flex items-center gap-4">
    <button id="menuBtn" class="text-2xl font-bold text-white cursor-pointer hover:bg-white hover:bg-opacity-10 rounded p-2 transition">☰</button>
    <h1 class="text-2xl text-white font-bold">School Health Clinic Management System</h1>
  </div>
...
<!-- Main Content -->
<main id="visitLogsCard" class="max-w-6xl mx-auto mt-6 bg-white p-6 rounded">
    <h2 class="text-xl font-bold text-center mb-4 text-red-600">Student Visit Logs</h2>

    <!-- Add Button -->
    <div class="flex justify-end mb-6">
        <button id="addNewVisitBtn" class="bg-red-400 text-white px-6 py-3 rounded-lg hover:bg-red-500 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                ...
                <?php if (count($logs) > 0): ?>
                    <?php foreach ($logs as $log): ?>
                        ...
                        >
                            ...
                            <td class="p-4 border border-gray-300 text-center flex justify-center items-center gap-2">
                                <button onclick="openModal(<?= $log['id'] ?>)" class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition-colors">Edit</button>
